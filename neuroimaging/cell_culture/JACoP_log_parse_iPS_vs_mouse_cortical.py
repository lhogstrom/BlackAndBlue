...
fname1 = '/Users/hogstrom/Dropbox (MIT)/imaging_data/20150529/analysis/metrics for PSD95_MAP2_SYN1_9_w2Conf 561.TIF and PSD95_MAP2_SYN1_9_w3Conf 640.txt'
fname2 = '/Users/hogstrom/Dropbox (MIT)/imaging_data/20150708/analysis/metrics for PSD95_SYN1_MAP_F4_1_09_w3Conf 561.TIF and PSD95_SYN1_MAP_F4_1_09_w4Conf 640.txt'
...
metric = "M1_thr"
boxDict = {}
boxDict['mouse cortical'] = colocFrm.ix[ixDict[fname1],metric]
boxDict['human iPS cortical'] = colocFrm.ix[ixDict[fname2],metric]
...
outF = os.path.join(graphDir,'mouse_vs_iPSC_PSD95_SYN1_Manders_M1.png')
