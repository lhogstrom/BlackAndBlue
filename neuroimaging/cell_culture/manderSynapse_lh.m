...
global fig_num
fig_path = ['/Users/hogstrom/Dropbox (MIT)/imaging_data/20150716'];
%Set parameters
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% IabCell = mat2cell(Iab,size(Iab,1)/1*[1 1],size(Iab,2)/1*[1 1]); %1x2
% IabCell = mat2cell(Iab,size(Iab,1)/2*[1 1],size(Iab,2)/2*[1 1]); %2x2
...
% create 4x4 grid:
IabCell = mat2cell(Iab,size(Iab,1)/4*[1 1],size(Iab,2)/4*[1 1]); %2x2
ImarkerCell = mat2cell(Imarker,size(Imarker,1)/4*[1 1],size(Imarker,2)/4*[1 1]);
abMaskCell = mat2cell(abMask,size(abMask,1)/4*[1 1],size(abMask,2)/4*[1 1]);
markerMaskCell = mat2cell(markerMask,size(markerMask,1)/4*[1 1],size(markerMask,2)/4*[1 1]);
nucMaskCell = mat2cell(nucMask,size(nucMask,1)/4*[1 1],size(nucMask,2)/4*[1 1]);
