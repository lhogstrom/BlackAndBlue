imageCount = 122
for (image = 100; image <= imageCount; image++) {
    if (image <=9){
        str_n = "0" + image;
    }
    else {
    ...
    open("/Users/hogstrom/Dropbox (MIT)/imaging_data/20150630/PSD95_SYN1_MAP2_" + str_n + "_w1Conf 405.TIF");
    //run("Brightness/Contrast...");
    run("Enhance Contrast", "saturated=0.35");
    open("/Users/hogstrom/Dropbox (MIT)/imaging_data/20150630/PSD95_SYN1_MAP2_" + str_n + "_w2Conf 488.TIF");
    //run("Brightness/Contrast...");
    run("Enhance Contrast", "saturated=0.35");
    open("/Users/hogstrom/Dropbox (MIT)/imaging_data/20150630/PSD95_SYN1_MAP2_" + str_n + "_w3Conf 561.TIF");
    //run("Brightness/Contrast...");
    run("Enhance Contrast", "saturated=0.35");
    open("/Users/hogstrom/Dropbox (MIT)/imaging_data/20150630/PSD95_SYN1_MAP2_" + str_n + "_w4Conf 640.TIF");
    //run("Brightness/Contrast...");
    run("Enhance Contrast", "saturated=0.35");
    ...
    saveAs("Tiff", "/Users/hogstrom/Dropbox (MIT)/imaging_data/20150630/PSD95_SYN1_MAP2_" + str_n + "  _auto_contrast.tif");
    close();
}

// For the imaging session on 20150702
imageCount = 133
for (image = 100; image <= imageCount; image++) {
    if (image <=9){
        str_n = "0" + image;
